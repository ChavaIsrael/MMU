...
class CacheUnitTest {
    ...
    void test() throws IOException {
        ...
        for (int i = 0; i < capacity; i++) {
            dataModelArray[i] = new DataModel<>(i, "This is page " + i);
        }

        cacheUnit.putDataModels(dataModelArray);
        DataModel<String>[] shortArray = new DataModel[]{new DataModel<>(0L, "This is page 0"), new DataModel<>(1L, "This is page 1")};
        ...
        for (int i = capacity; i < capacity*2; i++) {
            dataModelArray2[i-capacity] = new DataModel<>(i, "This is page " + i);
        }
